...
INSERT INTO `admin` VALUES (10,'admin@gmail.com','1234','akshay');
...
DROP TABLE IF EXISTS `combo_cart`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `combo_cart` (
  ...
  `cc_img` varchar(255) DEFAULT NULL,
  `cc_price` decimal(10,2) NOT NULL DEFAULT 0.00,
  `cc_quantity` int(11) NOT NULL DEFAULT 1,
  `cc_total` decimal(10,2) NOT NULL DEFAULT 0.00,
  `created_at` timestamp NOT NULL DEFAULT current_timestamp(),
  `updated_at` timestamp NOT NULL DEFAULT current_timestamp() ON UPDATE current_timestamp(),
  PRIMARY KEY (`cc_id`),
  UNIQUE KEY `uq_combo_cart_user_combo` (`id`,`combo_id`),
  KEY `idx_combo_cart_user` (`id`),
  KEY `idx_combo_cart_combo` (`combo_id`),
  CONSTRAINT `fk_combo_cart_combo_id` FOREIGN KEY (`combo_id`) REFERENCES `combos` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `combo_cart`
--

LOCK TABLES `combo_cart` WRITE;
/*!40000 ALTER TABLE `combo_cart` DISABLE KEYS */;
/*!40000 ALTER TABLE `combo_cart` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `combo_products` (
  ...
  KEY `idx_combo_products_product_id` (`product_id`),
  CONSTRAINT `fk_combo_products_combo_id` FOREIGN KEY (`combo_id`) REFERENCES `combos` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `fk_combo_products_product_id` FOREIGN KEY (`product_id`) REFERENCES `products` (`p_id`) ON DELETE CASCADE ON UPDATE CASCADE
...
INSERT INTO `combo_products` VALUES (4,1,18,1),(5,1,20,1),(6,1,21,1),(7,1,24,1);
...
INSERT INTO `combos` VALUES (1,'Crown Of Elegance HairCare Collection','ClassyCut\'s Hair Oil nourishes and protects your hair with a luxurious, silky smooth finish.',1199.00,'1775469858_combo_haircombo.jpg',1,'2026-04-06 10:04:18','2026-04-06 10:04:18');
...
INSERT INTO `membership_payments` VALUES (2,6,'Yearly Royal Pass',11999.00,'akshay','1234567890','manual',NULL,NULL,'2024-10-09 19:26:00','active'),(4,6,'Yearly Royal Pass',11999.00,'akshay','1234567890','manual',NULL,NULL,'2024-10-09 19:28:39','active'),(5,6,'Monthly Classic Pass',699.00,'akshay','1234567890','manual',NULL,NULL,'2024-10-09 19:31:00','active'),(7,6,'Yearly Royal Pass',11999.00,'akshay hariyani','7575852866','stripe','pi_3TJAhAA7H6HALvmQ15SMBjxz','succeeded','2026-04-06 07:17:55','active');
...
CREATE TABLE `membership_plans` (
  ...
  UNIQUE KEY `uq_membership_plans_mp_id` (`mp_id`)
...
CREATE TABLE `membership_transactions` (
  ...
  `membership_name` varchar(180) NOT NULL,
  `billing_plan` varchar(20) NOT NULL DEFAULT 'monthly',
  ...
  `cancelled_by_admin_id` int(11) DEFAULT NULL,
  `created_at` timestamp NOT NULL DEFAULT current_timestamp(),
  `updated_at` timestamp NOT NULL DEFAULT current_timestamp() ON UPDATE current_timestamp(),
  PRIMARY KEY (`mt_id`),
  UNIQUE KEY `uq_membership_transactions_pay_id` (`pay_id`),
  KEY `idx_membership_transactions_user` (`user_id`),
  KEY `idx_membership_transactions_status` (`status`),
  KEY `idx_membership_transactions_end_date` (`end_date`),
  KEY `membership_transactions_ibfk_plan` (`mp_id`),
  KEY `membership_transactions_ibfk_admin` (`cancelled_by_admin_id`),
  CONSTRAINT `membership_transactions_ibfk_admin` FOREIGN KEY (`cancelled_by_admin_id`) REFERENCES `admin` (`admin_id`) ON DELETE SET NULL ON UPDATE CASCADE,
  CONSTRAINT `membership_transactions_ibfk_payment` FOREIGN KEY (`pay_id`) REFERENCES `payment` (`pay_id`) ON DELETE SET NULL ON UPDATE CASCADE,
  CONSTRAINT `membership_transactions_ibfk_plan` FOREIGN KEY (`mp_id`) REFERENCES `membership_plans` (`mp_id`) ON DELETE SET NULL ON UPDATE CASCADE,
  CONSTRAINT `membership_transactions_ibfk_user` FOREIGN KEY (`user_id`) REFERENCES `user_reg` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
...
LOCK TABLES `membership_transactions` WRITE;
/*!40000 ALTER TABLE `membership_transactions` DISABLE KEYS */;
INSERT INTO `membership_transactions` VALUES (1,74,6,1,'Yearly Royal Pass','yearly',11999.00,'2024-10-10','2025-10-10','expired','2024-10-10 00:56:00',NULL,NULL,'2026-04-06 11:30:11','2026-04-06 11:30:11'),(2,75,6,1,'Yearly Royal Pass','yearly',11999.00,'2024-10-10','2025-10-10','expired','2024-10-10 00:58:39',NULL,NULL,'2026-04-06 11:30:11','2026-04-06 11:30:11'),(3,76,6,4,'Monthly Classic Pass','monthly',699.00,'2024-10-10','2024-11-10','expired','2024-10-10 01:01:00',NULL,NULL,'2026-04-06 11:30:11','2026-04-06 11:30:11'),(4,77,6,1,'Yearly Royal Pass','yearly',11999.00,'2026-04-06','2027-04-06','cancelled','2026-04-06 12:47:55','2026-04-06 17:31:26',10,'2026-04-06 11:30:11','2026-04-06 12:01:26');
/*!40000 ALTER TABLE `membership_transactions` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `payment` (
  ...
  `payment_for` varchar(30) NOT NULL DEFAULT 'product',
  ...
  KEY `s_id` (`s_id`),
  KEY `id` (`id`),
  KEY `idx_payment_m_id` (`m_id`),
  KEY `idx_payment_for` (`payment_for`),
  ...
  CONSTRAINT `payment_ibfk_membership_plan` FOREIGN KEY (`m_id`) REFERENCES `membership_plans` (`mp_id`) ON DELETE SET NULL ON UPDATE CASCADE
...
INSERT INTO `payment` VALUES (68,6,115,NULL,'product','Product order #115','akshay','2147483647','x','savarkundla','gujrat',364515,'Cash On Delivery',349.00,'2024-10-14','09:19:51','Pending',NULL,NULL),(69,6,116,NULL,'product','Product order #116','Hariyani akshay ','7676876788','testing','rajkot','gujrat',345678,'Stripe',499.00,'2026-03-28','09:56:18','Success','pi_3TFsfFA7H6HALvmQ1Ofud9A8','succeeded'),(70,6,117,NULL,'product','Product order #117','Hariyani Akshay','7766776677','testing address','rajkot','gujrat',364515,'stripe',399.00,'2026-03-28','11:02:35','paid','pi_3TFthOA7H6HALvmQ01JltC11','succeeded'),(71,6,118,NULL,'product','Product order #118','testing','6565656565','testing','rajkot','gujrat',556655,'stripe',279.00,'2026-03-28','11:41:02','paid','pi_3TFuIaA7H6HALvmQ0OEVWtc0','succeeded'),(72,6,119,NULL,'product','Product order #119','testing','112233445566','testing','testing','7766554433',223344,'cod',279.00,'2026-03-28','12:55:00','cancelled',NULL,NULL),(73,6,120,NULL,'product','Product order #120','testing','4455667788','testing','testing','testing',776655,'stripe',279.00,'2026-03-28','12:56:53','refunded','pi_3TFvU0A7H6HALvmQ1UntkqmG','succeeded'),(74,6,NULL,1,'membership','Yearly Royal Pass','akshay','1234567890','Membership','Membership','Membership',0,'manual',11999.00,'2024-10-10','00:56:00','active',NULL,NULL),(75,6,NULL,1,'membership','Yearly Royal Pass','akshay','1234567890','Membership','Membership','Membership',0,'manual',11999.00,'2024-10-10','00:58:39','active',NULL,NULL),(76,6,NULL,4,'membership','Monthly Classic Pass','akshay','1234567890','Membership','Membership','Membership',0,'manual',699.00,'2024-10-10','01:01:00','active',NULL,NULL),(77,6,NULL,1,'membership','Yearly Royal Pass','akshay hariyani','7575852866','Membership','Membership','Membership',0,'stripe',11999.00,'2026-04-06','12:47:55','cancelled','pi_3TJAhAA7H6HALvmQ15SMBjxz','succeeded'),(78,6,121,NULL,'product','Product order #121','hariyani akshay','7676857688','test test test','savarkundla','gujrat',787787,'stripe',1199.00,'2026-04-06','13:35:47','paid','pi_3TJBRNA7H6HALvmQ1xrnvZsF','succeeded');
...
CREATE TABLE `payment_integrations` (
  ...
  `sandbox_publishable_key` varchar(255) DEFAULT NULL,
...
INSERT INTO `payment_integrations` VALUES (1,'stripe','sandbox',1,'pk_test_51T8imlA7H6HALvmQf8faEZpyrlMcDT9RpqTxC0mKh6KnBInFa15Tp1sVQUGccaYmbXFY6VXCdBIx7clqis9X8hIQ00VY3YBuue','sk_test_51T8imlA7H6HALvmQMkpNxxmbsuTzJMap2yUJJwoYu7sceyy5V4ym2yEwK6z3zhJnXBeEfO08Enjc30EHVhk2KGqD00dHWTDuQ7',NULL,NULL,'2026-04-06 16:07:43','2026-04-06 16:05:21','2026-04-06 16:07:43');
...
INSERT INTO `product_categories` VALUES (1,'Hair care','2026-04-06 08:45:38','2026-04-06 08:45:53');
...
INSERT INTO `product_sales` VALUES (115,6,'hairpowder.jpg','Hair Powder',349,'100ml',1,349,349,'2024-10-14','Cancelled','09:19:51.000000'),(116,6,'homespray.jpg','Hair Spray',499,'100ml',1,499,499,'2026-03-28','Order Placed','09:56:18.000000'),(117,6,'shampoo.png','Hair Shampoo',399,'100ml',1,399,399,'2026-03-28','cancelled','11:02:35.000000'),(118,6,'hairpowder.jpg','Hair Powder',349,'100ml',1,279,279,'2026-03-28','confirmed','11:41:02.000000'),(119,6,'hairpowder.jpg','Hair Powder',349,'100ml',1,279,279,'2026-03-28','cancelled','12:55:00.000000'),(120,6,'hairpowder.jpg','Hair Powder',349,'100ml',1,279,279,'2026-03-28','refunded','12:56:53.000000'),(121,6,'1775469858_combo_haircombo.jpg','Crown Of Elegance HairCare Collection',1199,'Combo Pack',1,1199,1199,'2026-04-06','confirmed','13:35:47.000000');
...
CREATE TABLE `products` (
  ...
  CONSTRAINT `fk_products_category_id` FOREIGN KEY (`category_id`) REFERENCES `product_categories` (`category_id`) ON DELETE SET NULL ON UPDATE CASCADE
...
INSERT INTO `schema_migrations` VALUES (1,'2026_03_28_wallet_refund_checkout_flow','2026-03-28 11:53:14'),(2,'2026_04_06_product_categories_management','2026-04-06 08:45:00'),(3,'2026_04_06_combo_management','2026-04-06 10:00:38');
...
-- Dump completed on 2026-04-06 17:33:16
