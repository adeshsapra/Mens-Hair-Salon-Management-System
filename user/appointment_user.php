...
$filterConfig = [
    'search' => ['cols' => ['a_type', 'a_category'], 'type' => 'search'],
    'status' => ['col' => 'a_status', 'type' => 'equals'],
    'start_date' => ['col' => 'a_date', 'type' => 'date_start'],
    'end_date' => ['col' => 'a_date', 'type' => 'date_end']
];

$whereClause = buildSimpleWhere($con, $filterConfig, " AND ");

$app_query = "SELECT * FROM appointments WHERE a_name = '$username' $whereClause ORDER BY a_date DESC, a_time DESC";
